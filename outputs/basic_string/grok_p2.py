"""
A simple genetic algorithm to evolve a population of random strings toward a target string.
"""
...
def evaluate_fitness(candidate: str, target: str) -> PopulationScore:
    ...
    Returns:
        A tuple containing the candidate string and its matching character count.
    """
